...
// const allDataElements = (currentEle) => {
    
//     const divEle = document.createElement("div");
//     divEle.classList.add("main-to-do-list");
//     divEle.innerHTML = `<li>${currentEle}</li> <button class="dltbtn">Delete</button>`;
...
//     valArr.forEach((currentEle) => {

//         allDataElements(currentEle);
//     });
// }
